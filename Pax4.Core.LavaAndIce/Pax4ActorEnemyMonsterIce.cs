...
{
    [DataContract]
    [KnownType(typeof(Pax4ActorEnemyMonsterIce))]
    public class Pax4ActorEnemyMonsterIce : Pax4ActorEnemyMonster
    {
        public static Pax4ActorEnemyMonsterIce _current = null;

        public static float _scaleFactor = 5.5f;

        public Pax4ActorEnemyMonsterIce(String p_name, Pax4Object p_parent0, int p_modelIndex)
            : base(p_name, p_parent0)
        {
            ...
            _particleEffectAura.Ini(((Pax4ParticleEffectLavaAndIce)Pax4ParticleEffect._current)._particleEffectIceMonsterShield);
            ...
            _particleEffectAura1.Ini(((Pax4ParticleEffectLavaAndIce)Pax4ParticleEffect._current)._particleEffectIceMonsterShield);
            ...
            _particleEffectAura2.Ini(((Pax4ParticleEffectLavaAndIce)Pax4ParticleEffect._current)._particleEffectIceMonsterShield);
